...
{ 
  ...
  arts()
  {
     ...
     f=new Font("Arial",Font.BOLD,15);
      ...
      String s1="\n" +"Eligibility for Liberal Arts Programs (Duration: 3 years)\n" +"\n";
      String s2=  "(a) Nationality and Age\n" +"\n";
      String s3="Resident Indian or Non-Resident Indian (NRI), holder of PIO or OCI card issued by Government of India are eligible to apply for Selection Process." +"\n" +
"Note: NRIs, holders of PIO or OCI card issued by Government of India must apply under International student category only." +"\n" +
 
"\nShould have attained the age of 16 + on the 31st July of the calendar year in which the 12th Board or examination is to be held.\n" +"\n";

     String s4="(b) Qualifying Examination:"+"\n";
     String s5="\nAll Liberal Arts programmes:Minimum 60% aggregate in PCM" +"\n" +
